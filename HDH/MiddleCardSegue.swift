...
class MiddleCardSegue: UIStoryboardSegue {
    private var selfRetainer: MiddleCardSegue? = nil
...
extension MiddleCardSegue: UIViewControllerTransitioningDelegate {
    ...
    func animateTransition(using transitionContext: UIViewControllerContextTransitioning) {
        ...
        do {
            ...
            UIView.animate(withDuration: 0.5, delay: 0, usingSpringWithDamping: 0.8, initialSpringVelocity: 0, options: [], animations: {
                toView.frame.origin.y = originalOriginY - 245
            }) { (completed) in
